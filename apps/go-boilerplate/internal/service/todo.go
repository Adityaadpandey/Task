...
import (
	...
	"github.com/adityaadpandey/go-boilerplate/internal/lib/aws"
...
func NewTodoService(server *server.Server, todoRepo *repository.TodoRepository, catgoryRepo *repository.CategoryRepository, awsClient *aws.AWS) *TodoService {
	return &TodoService{
		server:       server,
		todoRepo:     todoRepo,
